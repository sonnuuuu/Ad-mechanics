          ...
          {[
                {
                  ...
                  description:
                    "Create compelling and engaging content that resonates with your audience and strengthens your brand.",
                },
                ...
                {
                  title: "Influcer Marketing",
                  description:
                    "Boost your brand's reach and engagement by partnering with top influencers in your industry.",
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
